...
public class GatosService {
    ...
    public static void verGatos() throws IOException{
        ...
        Gson gson = new Gson();
        Gatos gatos = gson.fromJson(elJson, Gatos.class);//SE LE PASA EL JSON A LA CLASE GATOS
        
        //redimensionar en caso de necesitar
        Image image = null;
        try{
            URL url = new URL(gatos.getUrl()); //LE PASAMOS LA URL DEL GATO
            image = ImageIO.read(url); //CARGA LA IMGEN URL
